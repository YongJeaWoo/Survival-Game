...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        talkData.Add(2000 + 10 + 1, new string[] {"지금이라도 찾으러 가 봐야 하나.. : 0"});

        talkData.Add(2000 + 20, new string[] {"그쪽은 누구야..? : 1",
                                            "나를 찾고 있는 사람이 있다고? : 1",
                                            "이 상황에 찾는 건 아마 내 오빠겠지? : 1",
                                            "하지만 난 다리를 다쳐서... : 1", 
                                            "거기까지 같이 가다가 괜히 발목만 잡을 거야. : 1",
        ...
        talkData.Add(1000 + 30, new string[] { "...",
                                                "그는 싸늘한 시체로 있다."});

        talkData.Add(2000 + 30, new string[] {"흑..흑.."});
        talkData.Add(2000 + 30 + 1, new string[] { "어째서.." });


        talkData.Add(1000 + 40, new string[] { "...",
                                                "그는 싸늘한 시체로 있다."});
        talkData.Add(2000 + 40, new string[] { "난.. 여기 남아있을게.. 그냥 가줘.." });
        talkData.Add(2000 + 40 + 1, new string[] { "제발 그냥 가.." });


        talkData.Add(1000 + 50, new string[] { "...",
                                                "그는 싸늘한 시체로 있다."});
        talkData.Add(2000 + 50, new string[] { "그 큰 괴물이 막고 있던 길은 뚫렸을거야..",
                                                "나는.. 잘 모르겠어.."});
        talkData.Add(2000 + 50 + 1, new string[] {"이제 더 이상 건들지 말아줘."});
        talkData.Add(2000 + 50 + 2, new string[] { "이제 더 이상 건들지 말아줘." });
        
        talkData.Add(1000 + 60, new string[] {"...",
                                                "그는 싸늘한 시체로 있다."});
        talkData.Add(2000 + 60, new string[] { "이제 더 이상 건들지 말아줘." });
    }
